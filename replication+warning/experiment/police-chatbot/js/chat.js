...
const isRogue = (searchParams.get('R').toLowerCase() === "true");
const needsWarning = (searchParams.get('W').toLowerCase() === "true");
// console.log("rogue: " + isRogue + ", warning: " + needsWarning)

if (needsWarning) {
	const myDiv = document.getElementById("warning");
	myDiv.style.display = "block";
	const hiddenText = document.querySelector("#warning .hidden-text");
...
function call_GPT3(following_phrase) {
	...
	var auth = "" //set OPENAI key here
	var org = "" //set OPENAI org here (if applicable)
